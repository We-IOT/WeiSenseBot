...
from weisensebot.agent.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
...
from weisensebot.agent.tools.web import WebFetchTool, WebSearchTool
from weisensebot.bus.events import InboundMessage, OutboundMessage
from weisensebot.bus.queue import MessageBus
from weisensebot.providers.base import LLMProvider
from weisensebot.session.manager import Session, SessionManager

if TYPE_CHECKING:
    from weisensebot.config.schema import ChannelsConfig, ExecToolConfig
...
class AgentLoop:
    ...
    def __init__(
        ...
        from weisensebot.config.schema import ExecToolConfig
        self.bus = bus
    ...
    async def _connect_mcp(self) -> None:
        ...
        from weisensebot.agent.tools.mcp import connect_mcp_servers
        try:
