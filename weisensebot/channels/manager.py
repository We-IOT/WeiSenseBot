...
class ChannelManager:
    ...
    Responsibilities:
    - Initialize enabled channels (Feishu, DingTalk, QQ, etc.)
    - Start/stop channels
    ...
    def _init_channels(self) -> None:
        ...
        if self.config.channels.discord.enabled:
            try:
                from weisensebot.channels.discord import DiscordChannel
        ...
        if self.config.channels.feishu.enabled:
            try:
                from weisensebot.channels.feishu import FeishuChannel
        ...
        if self.config.channels.mochat.enabled:
            try:
                from weisensebot.channels.mochat import MochatChannel
        ...
        if self.config.channels.dingtalk.enabled:
            try:
                from weisensebot.channels.dingtalk import DingTalkChannel
        ...
        if self.config.channels.email.enabled:
            try:
                from weisensebot.channels.email import EmailChannel
        ...
        if self.config.channels.slack.enabled:
            try:
                from weisensebot.channels.slack import SlackChannel
        ...
        if self.config.channels.qq.enabled:
            try:
                from weisensebot.channels.qq import QQChannel
        ...
        if self.config.channels.matrix.enabled:
            try:
                from weisensebot.channels.matrix import MatrixChannel
